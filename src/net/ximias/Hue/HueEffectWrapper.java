package net.ximias.Hue;


import javafx.scene.paint.Color;
import net.ximias.Hue.hueEffects.HueEffect;
import net.ximias.Hue.hueEffects.AreaEffectProducer;
import net.ximias.Hue.hueEffects.FrontCenterEffect;
import net.ximias.Hue.hueEffects.GlobalConstantEffect;
import net.ximias.Hue.hueEffects.MultiFrontCenterEffect;
...
public class HueEffectWrapper {
	...
	public HueEffect getAsHueEffect(Effect effectToWrap){
		...
		if (producer instanceof BlendingEffectProducer){
			...
			MultiEffectProducer mEffect = ((MultiEffectProducer) producer);
