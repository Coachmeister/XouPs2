...
public class LoginEventsTestScene extends EffectScene {
	
	public LoginEventsTestScene(EffectView view, Ps2EventStreamingConnection connection) {
	...
	private void simple() {
		...
		FadingEffectProducer white = new FadingEffectProducer("Long white fade", Color.WHITE, 2100);
		FadingEffectProducer red = new FadingEffectProducer("Long red fade", Color.RED, 2100);
		...
		SingleCondition worldIs1 = new SingleCondition("World is 1", Condition.EQUALS, c1, world);
		SingleCondition worldIs13 = new SingleCondition("World is 13", Condition.EQUALS, c13, world);
