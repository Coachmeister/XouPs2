...
public interface SceneConstants {
	...
	public static final int VS_ID = 1;
	public static final int NC_ID = 2;
	public static final int TR_ID = 3;
	
	public static final int INDAR_ID = 2;
	public static final int HOSSIN_ID = 4;
	public static final int AMERISH_ID = 6;
